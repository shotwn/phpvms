            ...
            @if ($config['raw_only'] != true && $metar)
                ...
                @if ($metar['temperature'])
                    <tr>
                        ...
                        <td>
                            ...
                            @if ($metar['dew_point']), @lang('widgets.weather.dewpoint')
                ...
                @if ($metar['barometer'])
                    <tr>
                        ...
                        <td>{{ number_format($metar['barometer']['hPa']) }} hPa /
                            {{ number_format($metar['barometer']['inHg'], 2) }} inHg</td>
                    </tr>
                @endif
