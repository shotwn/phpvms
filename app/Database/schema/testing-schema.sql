...
CREATE TABLE user_oauth_tokens (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, provider VARCHAR(255) NOT NULL, token CLOB NOT NULL, refresh_token CLOB NOT NULL, last_refreshed_at DATETIME DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL);
CREATE TABLE acars (id VARCHAR(36) NOT NULL, pirep_id VARCHAR(36) NOT NULL, type INTEGER NOT NULL, nav_type INTEGER DEFAULT NULL, "order" INTEGER DEFAULT 0 NOT NULL, name VARCHAR(255) DEFAULT NULL, status VARCHAR(255) DEFAULT 'SCH' NOT NULL, log VARCHAR(255) DEFAULT NULL, lat NUMERIC(10, 5) DEFAULT '0', lon NUMERIC(11, 5) DEFAULT '0', distance INTEGER DEFAULT NULL, heading INTEGER DEFAULT NULL, altitude_agl NUMERIC(8, 2) DEFAULT '0', vs DOUBLE PRECISION DEFAULT '0', gs INTEGER DEFAULT NULL, transponder INTEGER DEFAULT NULL, autopilot VARCHAR(255) DEFAULT NULL, fuel NUMERIC(10, 0) DEFAULT NULL, fuel_flow NUMERIC(10, 0) DEFAULT NULL, sim_time VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, ias INTEGER DEFAULT NULL, "altitude_msl" numeric default '0', "source" varchar, PRIMARY KEY(id));
CREATE INDEX acars_created_at_index ON acars (created_at);
CREATE INDEX acars_pirep_id_index ON acars (pirep_id);
CREATE TABLE IF NOT EXISTS "simbrief_aircraft" ("id" integer primary key autoincrement not null, "icao" varchar not null, "name" varchar not null, "details" text, "created_at" datetime, "updated_at" datetime);
CREATE TABLE IF NOT EXISTS "simbrief_airframes" ("id" integer primary key autoincrement not null, "icao" varchar not null, "name" varchar not null, "airframe_id" varchar, "source" integer, "details" text, "options" text, "created_at" datetime, "updated_at" datetime);
CREATE TABLE IF NOT EXISTS "simbrief_layouts" ("id" varchar not null, "name" varchar not null, "name_long" varchar not null, "created_at" datetime, "updated_at" datetime);
CREATE TABLE aircraft (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, subfleet_id INTEGER NOT NULL, icao VARCHAR(255) DEFAULT NULL, iata VARCHAR(255) DEFAULT NULL, airport_id VARCHAR(255) DEFAULT NULL, landing_time DATETIME DEFAULT NULL, name VARCHAR(255) NOT NULL, registration VARCHAR(255) DEFAULT NULL, hex_code VARCHAR(255) DEFAULT NULL, zfw NUMERIC(10, 2) DEFAULT '0', flight_time INTEGER DEFAULT 0, status VARCHAR(255) DEFAULT 'A' NOT NULL, state INTEGER DEFAULT 0 NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, mtow NUMERIC(10, 2) DEFAULT '0', fuel_onboard NUMERIC(10, 0) DEFAULT '0', hub_id VARCHAR(255) DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, fin VARCHAR(255) DEFAULT NULL, selcal VARCHAR(255) DEFAULT NULL, dow NUMERIC(10, 2) DEFAULT NULL, mlw NUMERIC(10, 2) DEFAULT NULL, simbrief_type VARCHAR(255) DEFAULT NULL);
...
INSERT INTO migrations VALUES(97,'2024_07_02_164640_update_tokens_in_user_oauth_tokens',4);
INSERT INTO migrations VALUES(98,'2024_07_09_210356_update_db_charset',4);
INSERT INTO migrations VALUES(99,'2024_15_07_164640_add_detailed_altitude',4);
INSERT INTO migrations VALUES(100,'2024_11_16_105923_create_simbrief_support_tables',5);
INSERT INTO migrations VALUES(101,'2024_11_22_182419_update_aircraft_table',5);
INSERT INTO migrations VALUES(102,'2024_12_03_093851_add_sources_to_acars_table',5);
